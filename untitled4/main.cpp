 ...
 *               Als Default wird die Datei zitat.txt verwendet
*/
int main(int nParameter, char *parameter[]) {
    ...
    try {
        ...
        cout << "  kopie2:" << endl;
        kopie2.info();
        cout << "Fifo sollte noch alle Elemente enthalten - tatsaechliche Anzahl der Elemente: " << kopie2.size()
             << endl;
    ...
    cout << "*** Es werden nun Fifo-Unterlaeufe passieren ***" << endl;
    {
        ...
        try {
            ...
            cout << help << endl;
            s >> help;
            cout << help << endl; // Hier muss ein Unterlauf passieren
        } catch (const char *error) {
            cout << "> Erwartete Ausnahme wegen Fifo-Unterlauf:" << endl;
            cout << " >>> " << error << endl;
        } catch (...) {
