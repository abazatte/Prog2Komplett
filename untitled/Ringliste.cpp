...
Ringliste::Ringliste(int _kapazitaet)
        : kapazitaet(_kapazitaet), leer(true), ring(_kapazitaet), lesePos(0), schreibPos(0) {}

//Kopierkonstruktor
Ringliste::Ringliste(const Ringliste &_rListe) = default;
